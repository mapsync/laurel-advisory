     ...
     <div>
       <div className="tab-menu-container show-xs">
        <div className="tab-menu btn-group btn-group-block">
          ...
          <a className="btn pt-2" rel="noopener noreferrer" href="https://bills.utilitydistrict.com/bills/default.aspx?id=8347" target="_blank">
      ...
      <div className="container grid-xs hide-xs">
        <header className="navbar">
          ...
          <section className="navbar-section">
            ...
            <a className="btn btn-link" rel="noopener noreferrer" href="https://bills.utilitydistrict.com/bills/default.aspx?id=8347" target="_blank">
